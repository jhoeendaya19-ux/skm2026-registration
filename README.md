...
- The public pages now have a fuller Off Ground footer with about, explore links, contact details, legal/admin access, and social links.
- The Off Ground homepage now has an About section.
